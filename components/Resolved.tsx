...
const Resolved: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const intervalId = setInterval(() => fetchResolvedIncidents(true), 60000); // Auto refresh en tiempo real cada 1 min
    ...
    const fetchResolvedIncidents = async (isBackgroundSync = false) => {
                                        ...
                                        <tr key={failure.id} className="hover:bg-zinc-900/40 transition-colors group">
                                            ...
                                            <td className="p-4 align-middle">
                                                <div className="flex flex-col items-start gap-1.5">
                                                    ...
                                                    <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold uppercase border ${isTotal
                                                ...
                                                <div className="grid grid-cols-1 gap-2">
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <>
                                                                {/* WAN 1 */}
                                                                <div className={`flex items-center justify-between px-2.5 py-1.5 rounded border transition-colors ${wan1Failed
                                                                ...
                                                                {/* WAN 2 */}
                                                                <div className={`flex items-center justify-between px-2.5 py-1.5 rounded border transition-colors ${wan2Failed
                                                                        ? 'bg-red-950/20 border-red-900/30'
                                                                        : 'bg-zinc-900/30 border-zinc-800/30 opacity-60'
                                                                    }`}>
                                                                    <div className="flex items-center gap-2.5 min-w-0">
