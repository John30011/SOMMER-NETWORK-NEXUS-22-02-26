  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      <button
        ...
        className={`w-full flex items-center justify-between bg-zinc-950 border rounded px-2 py-1.5 text-xs focus:outline-none transition-colors ${
            isOpen || !isAllSelected ? 'border-blue-500 ring-1 ring-blue-500/50' : 'border-zinc-800 hover:border-zinc-700'
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className={`truncate ${
                                isUnknown ? 'text-yellow-500 font-bold' : 
...
const Inventory: React.FC<InventoryProps> = ({ targetNetworkId }) => {
  ...
  const handleSaveChanges = async () => {
      ...
      try {
          if (isDemoMode) {
              ...
              setSelectedDevice({ ...selectedDevice, ...formData } as DeviceInventory);
          }
          setIsEditing(false);
      } catch (err: any) {
  ...
  return (
    ...
    <div className="p-4 md:p-8 h-[calc(100vh-5rem)] md:h-screen flex flex-col relative overflow-hidden bg-black">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <button 
            ...
            className={`p-2 md:p-2.5 border rounded-lg transition-colors flex items-center justify-center gap-2 shrink-0 ${
                showFilters 
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${
                                device.pais === 'VENEZUELA' ? 'bg-yellow-500 shadow-[0_0_5px_rgba(234,179,8,0.5)]' :
      ...
      <div 
        className={`fixed inset-y-0 right-0 w-full md:w-[600px] bg-zinc-950 border-l border-zinc-900 shadow-2xl transform transition-transform duration-300 ease-in-out z-[60] flex flex-col ${
                ...
                <div className="p-6 border-b border-zinc-900 flex justify-between items-start bg-zinc-900/50 backdrop-blur-md">
                    ...
                    <div className="flex flex-col items-end gap-2">
                        ...
                        {selectedDevice.updated_at && (() => {
                            ...
                            return (
                                <div className={`flex items-center gap-1.5 px-2 py-1 rounded border text-[10px] font-mono uppercase tracking-wide ${
                                    isRecent 
                            ...
                            <div className="flex gap-6 flex-wrap">
                                ...
                                <div className="flex items-center gap-3">
                                    <div 
                                        ...
                                        className={`w-10 h-5 rounded-full flex items-center transition-colors p-1 cursor-pointer ${
                                            (isEditing ? formData.es_tienda_top : selectedDevice.es_tienda_top) ? 'bg-blue-600' : 'bg-zinc-700'
                                    ...
                                    >
                                        <div className={`bg-white w-3 h-3 rounded-full shadow-md transform transition-transform ${
                                            (isEditing ? formData.es_tienda_top : selectedDevice.es_tienda_top) ? 'translate-x-5' : 'translate-x-0'
                                        }`}></div>
                                    </div>
                                ...
                                <div className="flex items-center gap-3">
                                    <div 
                                        ...
                                        className={`w-10 h-5 rounded-full flex items-center transition-colors p-1 cursor-pointer ${
                                            (isEditing ? formData.es_24_horas : selectedDevice.es_24_horas) ? 'bg-purple-600' : 'bg-zinc-700'
                                        } ${!isEditing ? 'pointer-events-none opacity-80' : ''}`}
                                    >
                                        <div className={`bg-white w-3 h-3 rounded-full shadow-md transform transition-transform ${
                                            (isEditing ? formData.es_24_horas : selectedDevice.es_24_horas) ? 'translate-x-5' : 'translate-x-0'
                                        }`}></div>
                                    </div>
                                ...
                                <div className="flex items-center gap-3">
                                    <div 
                                        ...
                                        className={`w-10 h-5 rounded-full flex items-center transition-colors p-1 cursor-pointer ${
                                            (isEditing ? formData.es_monitoreable : selectedDevice.es_monitoreable) ? 'bg-green-600' : 'bg-zinc-700'
                                        } ${!isEditing ? 'pointer-events-none opacity-80' : ''}`}
                                    >
                                        <div className={`bg-white w-3 h-3 rounded-full shadow-md transform transition-transform ${
                                            (isEditing ? formData.es_monitoreable : selectedDevice.es_monitoreable) ? 'translate-x-5' : 'translate-x-0'
                                        }`}></div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2" title="Es enlace de contingencia">
                                            ...
                                            <div 
                                                ...
                                                className={`w-8 h-4 rounded-full flex items-center transition-colors p-0.5 cursor-pointer ${
                                                    (isEditing ? formData.wan1_contingencia : selectedDevice.wan1_contingencia) ? 'bg-red-500' : 'bg-zinc-700'
                                                } ${!isEditing ? 'pointer-events-none opacity-80' : ''}`}
                                            >
                                                <div className={`bg-white w-3 h-3 rounded-full shadow-md transform transition-transform ${
                                                    (isEditing ? formData.wan1_contingencia : selectedDevice.wan1_contingencia) ? 'translate-x-4' : 'translate-x-0'
                                                }`}></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {isEditing ? (
                                            <select 
                                                ...
                                                onChange={(e) => handleInputChange('wan1_provider_id', e.target.value)}
                                                className="w-full bg-zinc-950 border border-zinc-700 rounded p-1.5 text-xs text-white focus:border-blue-500 outline-none"
                                            >
                                        ...
                                        {isEditing ? (
                                            <div className="flex">
                                                <input 
                                                    ...
                                                    className="w-full bg-zinc-950 border border-zinc-700 rounded-l p-1.5 text-xs text-white focus:border-blue-500 outline-none"
                                                    placeholder="0"
                                                />
                                                <select 
                                                    value={parseBW(formData.wan1_bw).unit}
                                                    onChange={(e) => handleBWChange('wan1_bw', 'unit', e.target.value)}
                                                    className="bg-zinc-800 border border-l-0 border-zinc-700 rounded-r px-2 text-xs text-zinc-300 focus:outline-none"
                                                >
                                     ...
                                     <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2" title="Es enlace de contingencia">
                                            ...
                                            <div 
                                                ...
                                                className={`w-8 h-4 rounded-full flex items-center transition-colors p-0.5 cursor-pointer ${
                                                    (isEditing ? formData.wan2_contingencia : selectedDevice.wan2_contingencia) ? 'bg-red-500' : 'bg-zinc-700'
                                                } ${!isEditing ? 'pointer-events-none opacity-80' : ''}`}
                                            >
                                                <div className={`bg-white w-3 h-3 rounded-full shadow-md transform transition-transform ${
                                                    (isEditing ? formData.wan2_contingencia : selectedDevice.wan2_contingencia) ? 'translate-x-4' : 'translate-x-0'
                                                }`}></div>
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div>
                                        ...
                                        {isEditing ? (
                                            <select 
                                                ...
                                                onChange={(e) => handleInputChange('wan2_provider_id', e.target.value)}
                                                className="w-full bg-zinc-950 border border-zinc-700 rounded p-1.5 text-xs text-white focus:border-blue-500 outline-none"
                                            >
                                                <option value="">Seleccionar...</option>
                                                {providers.map(p => <option key={p.id} value={p.id}>{p.name}</option>)}
                                        ...
                                        {isEditing ? (
                                            <div className="flex">
                                                ...
                                                <select 
                                                    ...
                                                    onChange={(e) => handleBWChange('wan2_bw', 'unit', e.target.value)}
                                                    className="bg-zinc-800 border border-l-0 border-zinc-700 rounded-r px-2 text-xs text-zinc-300 focus:outline-none"
                                                >
                                                    <option value="KB">KB</option>
                                                    <option value="MB">MB</option>
