      ...
      return (
          <div className="flex gap-4 relative group w-full">
              ...
              <div className="flex-1 pb-6 min-w-0">
                  <div className={`rounded-xl border p-3.5 transition-all relative overflow-hidden ${
                      isChecklist 
                      ...
                      <div className={`text-sm leading-relaxed whitespace-pre-wrap break-words ${
                          isChecklist ? 'font-mono text-zinc-200 text-xs' : 'text-zinc-200'
                      }`}>
                        ...
                        {closeCase && (
                            <div className="animate-in fade-in slide-in-from-left-2 duration-300 relative" ref={rootCauseRef}>
                                <button
                                    ...
                                    className={`flex items-center gap-2 bg-zinc-950 border rounded-md px-3 py-1.5 text-[10px] text-zinc-200 outline-none transition-all w-48 justify-between ${
                                        isRootCauseOpen ? 'border-green-500 ring-1 ring-green-500/20' : 'border-zinc-700 hover:border-zinc-600'
                                    }`}
                                >
                                        ...
                                        <div className="p-1 max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-800">
                                            {CAUSE_OPTIONS.map((opt) => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-3 py-2 text-[10px] rounded-lg transition-colors flex items-center justify-between group ${
                                                        rootCause === opt 
